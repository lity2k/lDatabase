...
Public Class PostgreSQL
    ...
    Public Function ExecuteDataTable(sql As String, Optional Parameters As Dictionary(Of String, Object) = Nothing) As DataTable Implements lDatabase.ExecuteDataTable
        ...
        Try
            Using conn As New NpgsqlConnection(dbConnection)
                conn.Open()
    ...
    Public Function ExecuteReader(sql As String, Optional Parameters As Dictionary(Of String, Object) = Nothing) As DataTable
        Dim dt As DataTable = New DataTable()
        Try
            Using conn As New NpgsqlConnection(dbConnection)
                conn.Open()
